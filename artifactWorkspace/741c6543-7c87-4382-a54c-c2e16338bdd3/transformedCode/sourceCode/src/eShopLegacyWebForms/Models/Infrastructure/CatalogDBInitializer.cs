...
namespace eShopLegacyWebForms.Models.Infrastructure
{
    public class CatalogDBInitializer : CreateDatabaseIfNotExists<CatalogDBContext>
    {
        ...
        public CatalogDBInitializer(CatalogItemHiLoGenerator indexGenerator, IWebHostEnvironment environment)
        {
        ...
        private void AddCatalogBrands(CatalogDBContext context)
        {
            var preconfiguredBrands = useCustomizationData
                ? GetCatalogBrandsFromFile(hostingEnvironment)
        ...
        private void AddCatalogItems(CatalogDBContext context)
        {
            var preconfiguredItems = useCustomizationData
                ? GetCatalogItemsFromFile(context, hostingEnvironment)
        ...
        static IEnumerable<CatalogBrand> GetCatalogBrandsFromFile(IWebHostEnvironment hostingEnvironment)
        {
            var contentRootPath = hostingEnvironment.ContentRootPath;
        ...
        static IEnumerable<CatalogItem> GetCatalogItemsFromFile(CatalogDBContext context, IWebHostEnvironment hostingEnvironment)
        {
            var contentRootPath = hostingEnvironment.ContentRootPath;
